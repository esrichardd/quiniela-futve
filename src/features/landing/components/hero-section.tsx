      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl">
        <div className="flex flex-col items-center gap-10 lg:flex-row lg:gap-12">
          <div className="min-w-0 flex-1 text-center lg:text-left">
            <div className="landing-glass-card landing-bright-border mb-6 inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-xs font-medium text-muted-foreground">
              <span
                aria-hidden="true"
